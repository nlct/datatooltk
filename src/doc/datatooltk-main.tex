...
\chapter{Importing Data}\label{sec:import}
   ...
   \widget{iosettings.tex.map} option has been selected in the 
   \dialog{preferences} dialog box (see \sectionref{sec:preferences}).
...
\widget{iosettings.tex.map} box is checked. The mapping table and
buttons are hidden if \widget{iosettings.tex.map} is unchecked. If
